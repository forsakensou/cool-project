...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    { $$ = single_Features($1); }
    | feature_list attr  /*several features*/
    { $$ = append_Features($1, single_Features($2)); }
    | feature_list method  /*several features*/
    { $$ = append_Features($1, single_Features($2)); }
    | feature_list error ';'
      {$$ = $1;}
    ;
    ...
    { $$ = attr($1, $3, $5); } /* expression question */
    | OBJECTID ':' TYPEID ';'
    { $$ = attr($1, $3, no_expr()); } /* expression question */
    ;
    ...
    formal : OBJECTID ':' TYPEID /*comma question*/
    { $$ = formal($1, $3); }
    ;

    expression_list :   /* with ';' ending */
    { $$ = nil_Expressions(); }
    | expression ';'
    ...
    expression_list2 :   /* without ';' ending */
    { $$ = nil_Expressions(); }
    | expression 
    { $$ = single_Expressions($1); }
